...
function TimetablePage({students,staff,user}) {
  ...
  useEffect(()=>{load("tnks_tt2").then(d=>{if(d)setTt(d);}); load("tnks_ttcfg").then(d=>{if(d){setCfg(d);setCfgEdit(d);}}); load("tnks_ttsetup").then(d=>{if(d)setSetupData(d);});},[]);
...
export default function App() {
  ...
  useEffect(()=>{
    (async()=>{
      const [u,s,r,c,a,f,st,lg]=await Promise.all([load("tnks_users"),load("tnks_students"),load("tnks_results"),load("tnks_comments"),load("tnks_announcements"),load("tnks_fees"),load("tnks_staff"),load("tnks_logo")]);
